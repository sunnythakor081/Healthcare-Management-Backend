...
//	@CrossOrigin(origins = "http://localhost:4204")
	public ResponseEntity<User> updateUserProfile(@RequestBody User user,@PathVariable Long id) throws Exception
	{
		User userobj = userRegisterService.updateUserProfile(id ,user);
	...
	public ResponseEntity<Appointments> addNewAppointment(@RequestBody Appointments appointment) throws Exception {
		...
		appointmentBookingService.updatePatientId(patientID,
